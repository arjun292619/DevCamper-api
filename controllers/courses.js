...
exports.getCourses = asyncHandler(async (req, res, next) => {
  if (req.params.bootcampId) {
    //noted a bug: not throwing an error if a bootcampId does not exist
...
exports.addCourse = asyncHandler(async (req, res, next) => {
  ...
  //User Authorization for Bootcamp Owner (only the bootcamp owner can  create or edit or delete the course)
